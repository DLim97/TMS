...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/register') }}"><b>Registration </b>Page</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('ic') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="ic" value="{{ old('ic') }}" placeholder="IC No.">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            ...
            <div class="form-group has-feedback{{ $errors->has('marital') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="marital" value="{{ old('marital') }}" placeholder="Marital">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
